...
const BUTTONS: MaintenanceButton[] = [
  ...
  { action: "refresh-track-library-full", label: "Track Library Full", description: "Full rebuild of permanent track metadata and all-time counts.", lane: "dashboard" },
  { action: "refresh-track-library-incremental", label: "Track Library Incremental", description: "Only add plays after the stored track-library checkpoint.", lane: "dashboard" },
  ...
  { action: "normalize-lastfm-imports", label: "Normalize Last.fm", description: "Match imported scrobbles against cached tracks or Spotify, then save them.", lane: "backfill" },
